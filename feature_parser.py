...
def parse(xml_filepath):
  fp = FeatureParser(xml_filepath)
  return fp.parse()
...
class FeatureParser(object):
  ...
  def _get_xml_feature_list(self):
    ...
    xml_doc = minidom.parse(self.xml_filepath)
    return xml_doc.getElementsByTagName('configurationOption')
  
if __name__ == '__main__':
  features = parse('project_public_1_feature_interaction/bdbc_model.xml')
  for key in features:
    print '==========\n', features[key]