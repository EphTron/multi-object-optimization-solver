...
def plot_scatter3d_of_generations(generation_info):
    ...
    pareto_label = 'Pareto Front\n(if "Number of Candidates at rank 0" > ' + str(
        generation_info["best_size"]) + ': shows ' + str(
        generation_info["best_size"]) + ' elements maximizing sparsity)'
